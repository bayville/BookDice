...
function showBasket() {
    ...
    if (document.getElementsByClassName("total-sum")) {
        for (let i = 0; i < totalSumEl.length; i++) {
            totalSumEl[i].innerHTML = sum + " SEK"; //Bytt till SEK från :-
        }
    }
    ...
    if (document.getElementById("basket")) {
        ...
        if (basketItems.length > 0) {
            ...
            for (let i = 0; i < basketItems.length; i++) {
                ...
                let newItemCostText = document.createTextNode(itemCost + " SEK"); //Bytt till SEK från :-
            ...
            let newItemText = document.createTextNode("Summa: " + sum + " SEK"); //Bytt till SEK från :-
...
function showSmallBasket() {
    if (document.getElementById("small-basket")) {
        ...
        if (basketItems.length > 0) {
            ...
            smallBasketEl.innerHTML = numOfItems + "st, " + sum + " SEK"; //Bytt till SEK från :-
...
function showCheckout() {
    if (document.getElementById("checkout")) {
        ...
        if (basketItems.length > 0) {
            ...
            // Lägg till summan sist
            checkoutEl.innerHTML += "<tr>" +
                "<td colspan='5' class='checkout-sum'>Summa: " + sum + " SEK</td>"; //Bytt till SEK från :-
...
function checkoutBasket() {
    ...
    if (basketItems != null) {
        ...
        if (itemCount == 1) {
            alert("Din order är mottagen! En vara - totalsumma: " + totalSum + " SEK"); //Bytt till SEK från :-
        } else {
            alert("Din order är mottagen! " + itemCount + " stycken varor - totalsumma: " + totalSum + "SEK"); //Bytt till SEK från :-
        }
